  ...
  render () {
    ...
    return (
      <div className="record-line">
          ...
          {this.props.block.userId == Meteor.userId() ? <input className="record-percent form-control" type="text" defaultValue={this.props.block.percent} onChange={this.handleChange}/> : ""}
  	    </div>
  	    <div className="record-hours-div">{hours}h</div>
  	    <div className="record-rate-div">
          {this.props.block.userId == Meteor.userId() ? <input className="record-rate form-control" type="text" defaultValue={this.props.block.rate} onChange={this.handleChange}/> : this.props.block.rate}
  	    </div>
